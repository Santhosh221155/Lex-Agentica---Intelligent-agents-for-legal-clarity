...
$root = 'd:/My projects/Self Healing RAG'
...
Start-Process -FilePath $python -ArgumentList @('-u','-m','uvicorn','backend.app.main:app','--host','127.0.0.1','--port','8000') -WorkingDirectory $root -RedirectStandardOutput $stdout -RedirectStandardError $stderr | Out-Null
